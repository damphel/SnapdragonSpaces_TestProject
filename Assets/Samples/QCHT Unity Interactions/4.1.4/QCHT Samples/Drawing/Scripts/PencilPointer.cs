...
namespace QCHT.Samples.Drawing
{
    ...
    public class PencilPointer : MonoBehaviour, IXRRayInteractorFilter
    {
        ...
        [SerializeField, Tooltip("Should it use hand tracking subsystem instead of pinch pen select actions.")]
        private bool UseHandTrackingSubsystem;
